...
describe('backofftimer', () => {
  ...
  describe('success', () => {
    ...
    return it('should adjust @longInterval to 0', () => {
      timer.success()
  ...
  describe('failure', () => {
    ...
    return it('should adjust @longInterval to .384 after 1 failure', () => {
      timer.failure()
      return timer.longInterval.toString().should.eql('0.384')
    })
  })

  return describe('getInterval', () => {
    ...
    return it('should be 7.168 after 2 failure', () => {
      timer.failure()
      timer.failure()
